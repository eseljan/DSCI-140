...
range(split_tickets$percentage_split)
...
mean(countycases$cases[countycases$county == "Multnomah"])
...
jails <- read_fwf("/cloud/project/Misc Data/jails.txt",
...
save(split_tickets, jails, file = "data_dsci140.RData")
